...
// 	{
// 		var err error
// 		cmdDirewolfTx := exec.Command("/usr/local/bin/direwolf", strings.Split(`-t 0 -p -B 300 -c ./direwolf-tx.conf`, " ")...)
...
// 	{
// 		var err error
// 		cmdDirewolfRx := exec.Command("/usr/local/bin/direwolf", strings.Split(`-t 0 -p -B 300 -c ./direwolf-rx.conf`, " ")...)
...
// 	{
// 		go receive(direwolfRxStdin, connRx)
// 	}
...
// 	var err error
// 	cmd := exec.Command("/usr/local/bin/direwolf", strings.Split(`-t 0 -p -B 300 -c ./direwolf-tx.conf`, " ")...)
...
// 	var err error
// 	cmd := exec.Command("/usr/local/bin/direwolf", strings.Split(`-t 0 -p -B 300 -c ./direwolf-rx.conf`, " ")...)
// 	stdout, err = cmd.StdoutPipe()
// 	if err != nil {
// 		panic(err)
// 	}
...
// 	cmdHackRF := exec.Command("hackrf_transfer", strings.Split(`-f 5000000 -p 1 -a 1 -t -`, " ")...)
...
// 	cmdHackRF := exec.Command("hackrf_transfer", strings.Split(`-f 5000000 -p 1 -a 1 -r -`, " ")...)
// 	go pipeStderrToTerminal("hackrf", cmdHackRF)
